...
import K8sMonSetup, {toc as K8sMonSetupTOC} from '../projects/k8s_monitoring/_setup.md';

<K8sMonSetup/>

## Task 1 - 20p

import K8sMonInstall, {toc as K8sMonInstallTOC} from '../projects/k8s_monitoring/_install.md';

<K8sMonInstall/>

import K8sMonService, {toc as K8sMonServiceTOC} from '../projects/k8s_monitoring/_service.md';

<K8sMonService/>

## Task 2 - 20p

import K8sMonExporter, {toc as K8sMonExporterTOC} from '../projects/k8s_monitoring/_exporter.md';

<K8sMonExporter/>

## Task 3 - 20p

import K8sMonHelm, {toc as K8sMonHelmTOC} from '../projects/k8s_monitoring/_helm.md';

<K8sMonHelm/>

import K8sMonPrometheus, {toc as K8sMonPrometheusTOC} from '../projects/k8s_monitoring/_prometheus.md';

<K8sMonPrometheus/>

## Task 4 - 20p
import K8sMonGrafana, {toc as K8sMonGrafanaTOC} from '../projects/k8s_monitoring/_grafana.md';
...
The deadline for submitting your zip archive is the 21st of May 2023, 23:55.

## Homework presentation

The homework must be presented during the last laboratory (30th of May 2023). You will have to briefly present what and how you have set up for your infrastructure and demonstrate that it
