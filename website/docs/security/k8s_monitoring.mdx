...
Run some Denial-of-Service (DoS) attacks against the nginx web server
...
The homework must be presented during laboratories up until the last laboratory.
You will have to briefly present what and how you have set up for your infrastructure and demonstrate that it works.
