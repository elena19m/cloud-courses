...
In the base virtual machine:
  * Download the laboratory archive from [here](http://swarm.cs.pub.ro/~carpalex/scgc/lab-dns.zip) in the `work` directory.
Use: `wget http://swarm.cs.pub.ro/~carpalex/scgc/lab-dns.zip` to download the archive.
