...
Use: `wget --user=user-curs --ask-password http://repository.grid.pub.ro/cs/scgc/laboratoare/lab-nfs.zip` to download the archive.
...
$ wget --user=user-curs --ask-password http://repository.grid.pub.ro/cs/scgc/laboratoare/lab-nfs.zip
$ unzip lab-nfs.zip
