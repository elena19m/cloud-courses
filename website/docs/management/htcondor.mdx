...
Use: `wget https://repository.grid.pub.ro/cs/scgc/laboratoare/lab-htcondor.zip` to download the archive.
...
$ wget https://repository.grid.pub.ro/cs/scgc/laboratoare/lab-htcondor.zip
$ unzip lab-htcondor.zip
...
import HTCBasics from '../common/htcondor/_htc.md';
