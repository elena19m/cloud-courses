...
In the base virtual machine:
  * Download the laboratory archive from [here](https://repository.grid.pub.ro/cs/cc/laboratoare/lab-kubernetes-part1.zip) in the `work` directory.
Use: `wget https://repository.grid.pub.ro/cs/cc/laboratoare/lab-kubernetes-part1.zip` to download the archive.
  * Extract the archive.
...
$ wget https://repository.grid.pub.ro/cs/cc/laboratoare/lab-kubernetes-part1.zip
