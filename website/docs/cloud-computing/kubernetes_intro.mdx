...
## Milestones
- **[30p] [Exercise 01: Working with pods](#exercise-working-with-pods)**
- **[30p] [Exercise 02: Baby's first ~steps~ deployment](#exercise-babys-first-steps-deployment)**
- **[20p] [Exercise 03: LET ME IN](#exercise-let-me-in)**
- **[20p] [Exercise 04: LET ME... IN?](#exercise-let-me-in)**
- **[20p] [Exercise 05: LET ME... GO?](#exercise-let-me-go)**

import K8sInstall from '../common/kubernetes/_install.md';

<K8sInstall/>

import K8sHeadlamp from '../common/kubernetes/_headlamp.md';
