...
## Milestones
- **[20p] [Exercise 01: Defining a liveness probe](#defining-a-liveness-probe)**
- **[20p] [Exercise 02: Defining a readiness probe](#defining-a-readiness-probe)**
- **[10p] [Exercise 03: Testing the scaled app](#testing-the-scaled-app)**
- **[15p] [Exercise 04: Stopping the load](#stopping-the-load)**
- **[20p] [Exercise 05: Fine tuning](#exercise---fine-tuning)**
- **[15p] [Exercise 06: Testing traffic routing](#testing-traffic-routing)**
